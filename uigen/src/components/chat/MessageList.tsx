...
const SUGGESTIONS = [
  ...
  "A dashboard with stats and a chart",
];
          ...
          <div className="flex flex-col gap-2 mt-5 w-full max-w-sm">
            {SUGGESTIONS.map((s) => (
              <button
                ...
                className="text-left text-sm px-4 py-2.5 rounded-xl border border-neutral-200 bg-white hover:bg-neutral-50 hover:border-neutral-300 text-neutral-600 transition-colors shadow-sm"
              >
                {s}
              </button>
            ))}
